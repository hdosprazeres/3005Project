...
Starting it up:
    ...
    packages are properly installed, open the terminal in the folder where the
    files are stored and type "npm init"

    2.Start the server by typing "nodemon server.js"
